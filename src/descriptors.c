...
// Descriptor de reporte modificado para definir 20 botones de G29 (14 standard + 6 marchas)
uint8_t const desc_hid_report[] = {
    ...
    0x29, 0x14,        //   Usage Maximum (20) -> 20 botones oficiales en G29 (0x14)
    0x15, 0x00,        //   Logical Minimum (0)
    0x25, 0x01,        //   Logical Maximum (1)
    0x75, 0x01,        //   Report Size (1)
    0x95, 0x14,        //   Report Count (20) -> 20 botones mapeados
    0x81, 0x02,        //   Input (Data,Var,Abs)
    0x05, 0x01,        //   Usage Page (Generic Desktop Ctrls)
    0x09, 0x33,        //   Usage (Rx)
    0x09, 0x34,        //   Usage (Ry)
